...
export default class StateManager {
   ...
   */
  putAccount(address: Buffer, account: any, cb: any): void {
  ...
  putContractCode(address: Buffer, value: Buffer, cb: any): void {
    this.getAccount(address, (err: Error, account: any) => {
      if (err) {
        return cb(err)
      }
  ...
  accountIsEmpty(address: Buffer, cb: any): void {
    this.getAccount.bind(this)(address, (err: Error, account: any) => {
      if (err) {
        return cb(err)
      }
