...
function runBlock(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var state, block, generateStateRoot, result, err_1, stateRoot, txos;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 12:
                     ...
                     */
                    _a.sent();
                    txos = ((this.sioMap || {}).receipts || []);
                    delete this.sioMap;
                    return [2 /*return*/, { receipts: result.receipts, results: result.results, txos: txos }];
            }
        });
    });
}
