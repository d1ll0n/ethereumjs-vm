...
var _a = require('ethereumjs-util'), generateAddress = _a.generateAddress, generateAddress2 = _a.generateAddress2, KECCAK256_NULL = _a.KECCAK256_NULL, MAX_INTEGER = _a.MAX_INTEGER, toBuffer = _a.toBuffer, stripHexPrefix = _a.stripHexPrefix, zeros = _a.zeros;
...
var EVM = /** @class */ (function () {
    ...
    EVM.prototype._executeCreate = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var account, _a, toAccount, newContractEvent, result, totalGas, returnFee, _code, retval;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        account = _b.sent();
                        if (!!message.fromMainnet) return [3 /*break*/, 3];
                        return [4 /*yield*/, this._reduceSenderBalance(account, message)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    ...
                    case 10:
                        ...
                        if (!(!result.exceptionError && result.returnValue && result.returnValue.toString() !== '')) return [3 /*break*/, 12];
                        console.log('Stored code!');
                        return [4 /*yield*/, this._state.putContractCode(message.to, result.returnValue)];
                    case 11:
                        _b.sent();
                        _b.label = 12;
                    case 12: return [4 /*yield*/, this._state.getContractCode(message.to)];
                    case 13:
                        _code = _b.sent();
                        ...
                        console.log(message);
                        if (message.fromMainnet)
                            console.log("Expected Contract at " + message.mainnetAddress.toString('hex'));
                        retval = {
                            gasUsed: result.gasUsed,
                            createdAddress: message.to,
                            execResult: result,
    ...
    EVM.prototype.runInterpreter = function (message, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var env, _a, eei, interpreter, interpreterRes, _b, result, gasUsed, returnValue;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._state.getAccount(message.to || zeros(32))];
                    case 1:
                        env = (_a.contract = _c.sent(),
                            _a);
                        ...
                        if (!message.mainnetAddress) return [3 /*break*/, 2];
                        _b = {
                            runState: interpreter._runState,
                            exceptionError: undefined,
                        };
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, interpreter.run(message.code, opts)];
                    case 3:
                        _b = _c.sent();
                        _c.label = 4;
                    case 4:
                        ...
                        return [2 /*return*/, __assign(__assign({}, result), { runState: __assign(__assign(__assign({}, interpreterRes.runState), result), eei._env), exceptionError: interpreterRes.exceptionError, gas: eei._gasLeft, gasUsed: gasUsed,
    ...
    EVM.prototype._generateAddress = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!message.mainnetAddress) return [3 /*break*/, 1];
                        addr = Buffer.isBuffer(message.mainnetAddress) ? message.mainnetAddress : Buffer.from(stripHexPrefix(message.mainnetAddress), 'hex');
                        return [3 /*break*/, 4];
                    case 1:
                        if (!message.salt) return [3 /*break*/, 2];
                        addr = generateAddress2(message.caller, message.salt, message.code);
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this._state.getAccount(message.caller)];
                    case 3:
                        acc = _a.sent();
    ...
    EVM.prototype._reduceSenderBalance = function (account, message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._state.putAccount(toBuffer(message.caller), account)];
            });
        });
    };
    EVM.prototype._addToBalance = function (toAccount, message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._state.putAccount(toBuffer(message.to), toAccount)];
            });
        });
    };
